...
#t = Tokenizer()
# 先ほど取得した各種キーを代入する
consumer_key="2G1tAIcjaNQzAuPae48h8E9uZ"
consumer_secret="vVQdkTFQQoEnj81HhhlGWuEdHOTuSJ2EjVhsQltrjcLu5Jamcc"
access_token_key="1454082920713359360-SEgwUQICHUnjrVJioXB6HgDnuFM2o4"
access_token_secret="fv2PAL6fJUwP9NzQcZzxhyQeqEkgQfon9QT8TkPEAZ3cq"

consumer_key="mEw7b87XfTb5NX5NQYhOlJIH9"
consumer_secret="pYA6dC5UTDpqPwJdGmEwYeIAWSpYrOQmlqtL6BkjSVt1Moht5q"
access_token_key="1453010826760179719-HHPvwVacS6tQ0VO20XrOYRFppAFomX"
access_token_secret="nSJOxjnQnEaKNes5uxyRN3aO6EU31gilxYgsu8rz2fwWG"

auth = tweepy.OAuthHandler(consumer_key, consumer_secret)
auth.set_access_token(access_token_key, access_token_secret)
api = tweepy.API(auth)

followers_ids = api.get_followers(count=0)
...
fukushi = ['絶えず']
meirei = ['知れ']
tweets = api.home_timeline(count=300)
for tweet in tweets:
    #if(tweet.user[id] == 1454082920713359360): continue
